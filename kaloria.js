function  calcCalory(){
    if(document.getElementById('gender').checked == true){
        ...
        return calcCalory_w();
    } else { alert('Adja meg a nemét elõsszõr')}
    
}
function calcCalory_w(){
    document.getElementById('calory').innerHTML = ' az ön kalória szükséglete: ' + 
    ...
    ) * valueOfA()) + ' Kcal' + '<br><br>' + ' Ha fogyni szeretne, 200-500 Kcal-val egyen kevesebbet!'
}
